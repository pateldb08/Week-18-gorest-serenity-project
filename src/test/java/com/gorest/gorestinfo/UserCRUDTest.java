...
public class UserCRUDTest extends TestBase {
     static int id;
     static String name = "Darshna" + TestUtils.getRandomValue();      // intializing variable from pojo class apart from id as alwyas new id is generated only in deleting reocrod with id we give specific id we wanted to delete
     static String email = "darshna" + TestUtils.getRandomValue() +"@gmail.com";
